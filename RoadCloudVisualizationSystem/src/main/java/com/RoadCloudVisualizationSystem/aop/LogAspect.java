package com.RoadCloudVisualizationSystem.aop;
...
import com.RoadCloudVisualizationSystem.log.enuns.BusinessStatus;
import com.RoadCloudVisualizationSystem.service.SysOperLogService;
import com.RoadCloudVisualizationSystem.utils.IpUtil;
...
public class LogAspect {
    ...
    private void handleLog(JoinPoint joinPoint, Log controllerLog, Exception e, Object jsonResult) {
        try {
            ...
            // 设置操作时间。
            sysOperLog.setOperTime(System.currentTimeMillis()+ "");
            // 保存操作日志
